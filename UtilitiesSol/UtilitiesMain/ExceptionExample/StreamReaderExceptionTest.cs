...
namespace UtilitiesMain.ExceptionExample
{
    ...
    public class StreamReaderExceptionTest
    {
        ...
        public void TestStreamReader()
        {
            try
            {
                ...
                //using (StreamReader reader = new StreamReader((string) null))
                //using (StreamReader reader = new StreamReader(""))
                using (StreamReader reader = new StreamReader(@"X:\MyDir\MyFile.txt"))
                //using (StreamReader reader = new StreamReader(@"Y:\MyDir\MyFile.txt"))
                {
